...
public class SalaController {
    ...
    @PostMapping
    @Secured({"ROLE_ADMIN"})
    public ResponseEntity<SalaDto> create(@RequestBody SalaDtoPost data, UriComponentsBuilder uriBuilder) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SalaDto> update(@PathVariable Long id, @RequestBody SalaDtoPut data) {
